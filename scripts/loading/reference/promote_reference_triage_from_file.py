...
def add_paper(pmid, created_by, date_created):
    ...
    [reference_id, authors, doi_url, pmc_url, sgdid] = insert_referencedbentity(pmid, source_id, 
                                                                                record, created_by,
                                                                                date_created)
    
    insert_authors(reference_id, authors, source_id, created_by, date_created)
    insert_pubtypes(pmid, reference_id, record.get('pubtypes', []), source_id, created_by, date_created)
    insert_urls(pmid, reference_id, doi_url, pmc_url, source_id, created_by, date_created)

    DBSession.commit()

    return (reference_id, sgdid)

def insert_urls(pmid, reference_id, doi_url, pmc_url, source_id, created_by, date_created):
...
def insert_pubtypes(pmid, reference_id, pubtypes, source_id, created_by, date_created):
...
def insert_abstract(pmid, reference_id, record, source_id, journal_abbrev, journal_title, issn_print, created_by, date_created):
...
def insert_authors(reference_id, authors, source_id, created_by, date_created):
    if len(authors) == 0:
        return
...
def insert_referencedbentity(pmid, source_id, record, created_by, date_created):
    
    pubdate = record.get('pubdate')
    pubstatus = record.get('publication_status')
    date_revised = record.get('date_revised')
    journal_id, journal, journal_title, issn_print = get_journal_id(record, created_by, date_created)
    ...
    insert_abstract(pmid, dbentity_id, record,
                    source_id, journal, journal_title, issn_print, created_by, date_created)
...
def insert_relations(pmid, reference_id, record, created_by, date_created):
    tag_to_type = {
        "CON":  "Comment",
        "CIN":  "Comment",
        "EIN":  "Erratum",
