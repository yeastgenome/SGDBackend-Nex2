...
protein_seq_file = 'data/newUpdated_protein_R64-5.fsa'
protparam_file = 'data/newUpdated_protparam_R64-5.txt'
codonw_file = 'data/newUpdated_coding_codonw_R64-5.out'
