...
from src.models import Dnasequenceannotation
...
def load_seq():
    ...
    for line in f:
        ...
        if genomic_key not in key_to_annotation_id:
            insert_dnasequenceannotation(nex_session, genomic_dna_type, dbentity_id, so_id,
                                         contig_id, taxonomy_id, strand, genomic_start_index,
        ...
        if oneKB_key not in key_to_annotation_id:
            insert_dnasequenceannotation(nex_session, oneKB_dna_type, dbentity_id, so_id,
                                         contig_id, taxonomy_id, strand, oneKB_start_index,
...
def insert_dnasequenceannotation(nex_session, dna_type, dbentity_id, so_id, contig_id, taxonomy_id, strand, start_index, end_index, file_header, download_filename, seq):
